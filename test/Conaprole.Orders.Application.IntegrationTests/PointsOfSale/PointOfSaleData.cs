...
namespace Conaprole.Orders.Application.IntegrationTests.PointsOfSale
{
    ...
    public static class PointOfSaleData
    {
        ...
        public const string PhoneNumber = "+59812345678";
        public const string City = "Montevideo";
        public const string Street = "Calle Test 456";
        ...
        /// <summary>
        /// Crea un punto de venta con un número de teléfono único y devuelve su ID.
        /// </summary>
