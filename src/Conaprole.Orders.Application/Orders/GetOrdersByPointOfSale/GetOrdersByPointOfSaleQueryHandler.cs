...
internal sealed class GetOrdersByPointOfSaleQueryHandler : IQueryHandler<GetOrdersByPointOfSaleQuery, List<OrderSummaryResponse>>
{
    private readonly ISqlConnectionFactory _sqlConnectionFactory;

    public GetOrdersByPointOfSaleQueryHandler(ISqlConnectionFactory sqlConnectionFactory)
    {
        _sqlConnectionFactory = sqlConnectionFactory;
    }

    public async Task<Result<List<OrderSummaryResponse>>> Handle(GetOrdersByPointOfSaleQuery request, CancellationToken cancellationToken)
    {
        ...
        WHERE pos.phone_number = @PointOfSalePhoneNumber
