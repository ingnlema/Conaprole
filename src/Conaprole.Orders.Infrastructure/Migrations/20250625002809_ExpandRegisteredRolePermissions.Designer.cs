...
namespace Conaprole.Orders.Infrastructure.Migrations
{
    ...
    [Migration("20250625002809_ExpandRegisteredRolePermissions")]
    partial class ExpandRegisteredRolePermissions
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Conaprole.Orders.Domain.Users.Permission", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 4,
                            Name = "distributors:write"
                        },
                        new
                        {
                            Id = 5,
                            Name = "pointsofsale:read"
                        },
                        new
                        {
                            Id = 6,
                            Name = "pointsofsale:write"
                        },
                        new
                        {
                            Id = 7,
            ...
            modelBuilder.Entity("Conaprole.Orders.Domain.Users.User", b =>
                {
                    ...
                    b.HasIndex("DistributorId")
                        .HasDatabaseName("ix_users_distributor_id");
            ...
            modelBuilder.Entity("Conaprole.Orders.Domain.Users.User", b =>
                {
                    b.HasOne("Conaprole.Orders.Domain.Distributors.Distributor", "Distributor")
                        .WithMany()
                        .HasForeignKey("DistributorId")
                        .HasConstraintName("fk_users_distributor_distributor_id");
