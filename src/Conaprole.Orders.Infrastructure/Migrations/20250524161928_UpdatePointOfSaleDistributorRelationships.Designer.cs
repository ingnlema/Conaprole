...
namespace Conaprole.Orders.Infrastructure.Migrations
{
    ...
    [Migration("20250524161928_UpdatePointOfSaleDistributorRelationships")]
    partial class UpdatePointOfSaleDistributorRelationships
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Conaprole.Orders.Domain.PointsOfSale.PointOfSaleDistributor", b =>
                {
                    ...
                    b.Property<Guid>("PointOfSaleId1")
                        .HasColumnType("uuid")
                        .HasColumnName("point_of_sale_id1");
                    ...
                    b.HasIndex("PointOfSaleId1")
                        .HasDatabaseName("ix_point_of_sale_distributor_point_of_sale_id1");
            ...
            modelBuilder.Entity("Conaprole.Orders.Domain.PointsOfSale.PointOfSaleDistributor", b =>
                {
                    ...
                    b.HasOne("Conaprole.Orders.Domain.PointsOfSale.PointOfSale", null)
                        .WithMany()
                        .HasForeignKey("PointOfSaleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                    ...
                    b.HasOne("Conaprole.Orders.Domain.PointsOfSale.PointOfSale", "PointOfSale")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_point_of_sale_distributor_point_of_sale_point_of_sale_id1");
